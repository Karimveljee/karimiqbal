...
1.  Run YouTubenews01.R. (prerequisites: YouTube developer API). Repeat the data collection of CNN's channel stats, video stats and comments. - I tried running it with Client ID and Client Secret but faced errors.
...
3.  Can you use quanteda to analyze the text data from YouTube comments?
    ...
    nbc_videos1 = yt_search(term="genocide", type="video", channel_id = "UCeY0bbntWzzVIaj2z3QigXg")
